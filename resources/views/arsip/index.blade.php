        ...
        <div class="card-top">
            ...
            <div class="dropdown">               
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li>
                    <a class="dropdown-item" href="{{ route('arsip.home') }}">
                        <i class="bi bi-list-ul me-2"></i>Full Daftar
                    </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                    <a class="dropdown-item" href="{{ route('arsip.home-tahap', 1) }}">
                        <i class="bi bi-list-ul me-2"></i>Tahap 1
                    </a>
                    </li>
                    <li>
                    <a class="dropdown-item" href="{{ route('arsip.home-tahap', 2) }}">
                        <i class="bi bi-list-ul me-2"></i>Tahap 2
                    </a>
                    </li>
                    <li>
                    <a class="dropdown-item" href="{{ route('arsip.home-tahap', 3) }}">
                        <i class="bi bi-list-ul me-2"></i>Tahap 3
                    </a>
                    </li>
                    <li>
                    <a class="dropdown-item" href="{{ route('arsip.home-tahap', 4) }}">
                        <i class="bi bi-list-ul me-2"></i>Tahap 4
                    </a>
                    </li>
                </ul>
            </div>
