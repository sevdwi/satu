...
<div class="register-card" style="overflow: auto;">
  ...
  <div class="card-header-strip">
    ...
    <a class="navbar-brand" href="{{route('dashboard')}}"><span class="fw-bolder" style="color: #ffffff;">SATU</span></a> <span> </span> <img src="{{ asset('images/arsip2.png') }}" width="40" class="mb-3">
